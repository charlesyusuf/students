...
function showNotes(){
    ...
    if(notesObj.length!=0){
        ...
        notesElm.innerHTML = `<p style="color: white; margin-top: 20px; font-size: 20px;">Charles Mugambi student results view area (you will see results here after you save)</p>`;
    }
